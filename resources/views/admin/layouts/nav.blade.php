            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link"
                           ...
                           aria-expanded="false"><i
                                class="flag-icon flag-icon-{{ lang() == 'ar' ? 'eg':'us'}}"></i>
                            <span class="selected-language">{{ lang() == 'ar' ? __('admin.arabic') : __('admin.english')}}</span>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            ...
                            <a class="dropdown-item"
                               href="{{route('language','ar')}}" data-language="fr"><i
                                    class="flag-icon flag-icon-eg mr-50"></i>Arabic</a>
                        </div>
                    </li>
                            ...
                            <li class="scrollable-container media-list"><a class="d-flex justify-content-between"
                                ...
                                <div class="d-flex justify-content-between read-notification cursor-pointer">
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0"><img
                                                    src="/app-assets/images/portrait/small/avatar-s-16.jpg" alt="avatar"
                                                    height="39" width="39"></div>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="d-flex justify-content-between read-notification cursor-pointer">
                                    <div class="media d-flex align-items-center">
                                        <div class="media-left pr-0">
                                            <div class="avatar mr-1 m-0"><img
                                                    src="/app-assets/images/portrait/small/avatar-s-4.jpg" alt="avatar"
                                                    height="39" width="39"></div>
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span class="user-name">{{ username()}}</span><span
