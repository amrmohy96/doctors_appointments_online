                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <form class="form" action="{{route('appointments.update',$time->id)}}" method="post"
                            >
                                @csrf
                                @method('put')
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-label-group">
                                                <div class="mb-1">
                                                    <fieldset class="form-group position-relative">
                                                        <input type="date" name="date" value="{{$time->appointment->date}}"
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" name="from" value="{{$time->from}}"
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" name="to" value="{{$time->to}}"
